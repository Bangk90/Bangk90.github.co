...
if (isset($_POST['simpan'])) { //untuk create data
    ...
    if ($nama && $nim && $prodi) {
        if ($op == 'edit') { //untuk update data
            $sql1       = "update mahasiswa set  nama='$nama',nim = '$nim',prodi='$prodi' where id = '$id'";
            $q1         = mysqli_query($koneksi, $sql1);
            if ($q1) {
            ...
            $sql1   = "insert into mahasiswa (nama,nim,prodi) values ('$nama','$nim','$prodi')";
            $q1     = mysqli_query($koneksi, $sql1);
            if ($q1) {
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="" method="POST">
                    ...
                    <div class="mb-3 row">
                        <label for="prodi" class="col-sm-2 col-form-label">Program Study</label>
                        <div class="col-sm-10">
